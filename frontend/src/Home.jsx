...
const Home = () => {
  ...
  // Image-to-Image specific state - COMMENTED OUT FOR NOW
  ...
  /* COMMENTED OUT - Image-to-Image UI configurations
  const artStyles = [
  ...
  */
  ...
  /* COMMENTED OUT - Handle image file upload
  ...
  */
  ...
  const handleSubmit = async () => {
    /* COMMENTED OUT - Image-to-Image validation
    ...
    */
    ...
    try {
      ...
      /* COMMENTED OUT - Image-to-Image request body
      if (activeTab === 'img2img') {
        requestBody = {
          sourceImage,
  ...
  /* COMMENTED OUT - Image-to-Image UI rendering
    ...
    if (response.type === 'image') {
      return (
        <div className="response-box">
          ...
          {/* COMMENTED OUT - Comparison grid for img2img
    ...
    <div className="app">
      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="form">
            {/* COMMENTED OUT - Image-to-Image UI */}
